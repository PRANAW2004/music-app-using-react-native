        ...
        <View style={styles.folkview}>
            ...
            {telugudata.map((e)=>{
                ...
                <View style={{flex:1,width:'100%',display:"flex",justifyContent:"center"}}>
                    <Pressable style={{width:'100%',display:"flex",alignItems:"center"}} onPress={async ()=>{setsongdata(telugudata);await AsyncStorage.setItem("genre",JSON.stringify("telugu"));play(e['id']);setcurrentPlaying(e['id']);}}>
                    {/* <Pressable> */}
