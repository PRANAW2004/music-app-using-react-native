        ...
        <View style={styles.folkview}>
            ...
            {tamildata.map((e)=>{
                ...
                <View style={{flex:1,width:'100%',display:"flex",justifyContent:"center"}}>
                    <Pressable style={{width:'100%',display:"flex",alignItems:"center"}} onPress={async ()=>{setsongdata(tamildata);await AsyncStorage.setItem("genre",JSON.stringify("tamil"));play(e['id']);setcurrentPlaying(e['id']);}}>
                    {/* <Pressable> */}
