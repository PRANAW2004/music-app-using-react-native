        ...
        <View style={styles.folkview}>
            ...
            {rockdata.map((e)=>{
                ...
                <View style={{flex:1,width:'100%',display:"flex",justifyContent:"center"}}>
                    <Pressable style={{width:'100%',display:"flex",alignItems:"center"}} onPress={async ()=>{setsongdata(data);await AsyncStorage.setItem("genre",JSON.stringify("rock"));play(e['id']);setcurrentPlaying(e['id']);}}>
