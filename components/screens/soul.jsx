        ...
        <View style={styles.folkview}>
            ...
            {souldata.map((e)=>{
                ...
                <View style={{flex:1,width:'100%',display:"flex",justifyContent:"center"}}>
                    <Pressable style={{width:'100%',display:"flex",alignItems:"center"}} onPress={async ()=>{setsongdata(souldata);await AsyncStorage.setItem("genre",JSON.stringify("soul"));play(e['id']);setcurrentPlaying(e['id']);}}>
